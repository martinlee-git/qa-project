...
## Summary
AdventHealth는 의료용 ChatGPT를 사용하여 작업 흐름을 간소화하고 관리 부담을 줄이며 환자 치료에 더 많은 시간을 투자하고 있습니다.
