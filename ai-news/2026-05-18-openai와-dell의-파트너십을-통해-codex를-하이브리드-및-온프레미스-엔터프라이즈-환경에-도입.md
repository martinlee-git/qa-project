# OpenAI와 Dell의 파트너십을 통해 Codex를 하이브리드 및 온프레미스 엔터프라이즈 환경에 도입
- Source: OpenAI News
- Category: ai_news
...
## Summary
OpenAI와 Dell은 파트너십을 통해 Codex를 하이브리드 및 온프레미스 환경에 도입하여 기업이 데이터와 워크플로우 전반에 걸쳐 AI 코딩 에이전트를 안전하게 배포할 수 있도록 지원합니다.
